    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          author_name: data.author_name || 'JVSEOAGENCY',
          author_email: data.author_email || 'info@jvseoagency.es',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Editar Artículo del Blog</h1>
